...
public class ViewImpl {
  ...
  public void correctUser() throws IOException {
    appendable.append("The height and width must be between 6 and 15 inclusive,"
  ...
  public void chooseFleet() throws IOException {
    appendable.append("Please enter your fleet in the order Carrier[6], BattleShip[5], "
